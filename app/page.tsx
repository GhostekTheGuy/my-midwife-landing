  ...
  return (
    <div className="min-h-screen bg-[#FEFBFD] relative">
      ...
      <main className="relative z-10 w-full flex flex-col items-center">
        ...
        {/* Hero */}
        <div className="w-full max-w-[828px] px-4 sm:px-6 pt-12 sm:pt-16 pb-12 sm:pb-20">
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            {/* Copy */}
            <div className="order-1 w-full lg:w-1/2 text-center lg:text-left">
              <BlurFade delay={0.1}>
              ...
              <BlurFade delay={0.35}>
                <p className="text-[#E69FCD] text-sm sm:text-base font-medium mb-8 px-4 sm:px-0">
                  Bezpiecznie. Prywatnie. Na Twoich zasadach.
                </p>
              </BlurFade>
              <BlurFade delay={0.4}>
                <div className="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-3 sm:gap-4 mb-8 px-4 sm:px-0">
                  <LiquidButton className="bg-[#0b0b0b] text-white hover:text-white rounded-[11px] px-4 sm:px-[11px] py-2 sm:py-[11px] text-sm sm:text-base border-0 w-full sm:w-auto h-auto [--liquid-button-background-color:#414141] [--liquid-button-color:#0b0b0b]" onClick={() => openModal("hero_primary")}>
                    Dołącz teraz
                  </LiquidButton>
                  <LiquidButton className="bg-[#eac9df] text-white hover:text-white rounded-[11px] px-4 sm:px-[11px] py-2 sm:py-[11px] text-sm sm:text-base border-0 w-full sm:w-auto h-auto [--liquid-button-background-color:#e352ad] [--liquid-button-color:#eac9df]" onClick={() => window.open("https://mymidwife.vercel.app/", "_blank")}>
                    Sprawdź demo
                  </LiquidButton>
                </div>
              </BlurFade>
              <BlurFade delay={0.5}>
                <div className="mb-8">
                  ...
                  <div className="flex items-center justify-center lg:justify-start gap-6">
                    {[
                      { src: "/co-logos/logos1.png", alt: "BraveCamp" },
                      { src: "/co-logos/logos2.png", alt: "UAM INNOVATION HUB" },
                      { src: "/co-logos/logos3.png", alt: "Innovation Hub" },
                    ].map(({ src, alt }) => (
                      <Image key={alt} src={src} alt={alt} width={120} height={20} className="h-5 opacity-40 object-contain" loading="lazy" />
                    ))}
                  </div>
                </div>
              </BlurFade>
            ...
            <div className="order-2 w-full lg:w-1/2 relative overflow-hidden">
              <BlurFade delay={0.5} inView={false}>
                <div className="relative w-full max-w-full lg:max-w-md mx-auto overflow-hidden">
                  ...
                  <div className="absolute top-0 left-0 right-0 h-32 pointer-events-none z-30" style={{ background: 'linear-gradient(to top, transparent 0%, rgba(254,251,253,0.3) 30%, rgba(254,251,253,0.7) 60%, rgba(254,251,253,1) 100%)' }} />
                </div>
              </BlurFade>
            </div>
          </div>
